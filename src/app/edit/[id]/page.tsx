...
export default function EditShirtPage() {
  ...
  const handleDeleteShirt = async () => {
    const confirmDelete = confirm(
      "Archive this shirt? It will disappear from the dashboard."
    );
    ...
    <main className="min-h-screen bg-black text-white p-4 md:p-8">
      <div className="mx-auto max-w-3xl overflow-hidden rounded-3xl border border-zinc-800 bg-zinc-950 shadow-2xl">
        <div className="flex items-center justify-between border-b border-zinc-800 px-6 py-5">
          ...
          <h1 className="text-3xl font-bold">Edit Shirt</h1>
        ...
        <div className="space-y-5 p-5 md:p-8">
            ...
            >
              {imagePreview ? (
                ...
                <>
                  ...
                  <p className="mt-2 text-zinc-400">Click to choose an image</p>
                </>
              )}
            </button>
          </div>
              ...
              {Object.entries(sizes).map(([size, qty]) => (
                ...
                >
                  ...
                  <div className="flex items-center gap-8">
                    <button
                      type="button"
                      onClick={() => changeQty(size as keyof typeof sizes, -1)}
          ...
          <button
            type="button"
            onClick={handleDeleteShirt}
            className="w-full rounded-2xl border border-red-500 py-4 text-lg font-bold text-red-500 hover:bg-red-600 hover:text-white"
          >
            🗑️ Archive Shirt
          </button>
